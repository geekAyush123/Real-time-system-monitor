...
# For Worker Nodes: Change this to Master Node's IP address
# Example: KAFKA_BROKER = '192.168.1.100:9092'  (Master's IP)
KAFKA_BROKER = 'localhost:9092'  # Change to Master IP on Worker nodes
